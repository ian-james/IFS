...
testRec* _tValidFileTest1(int testNum){
    ...
    return _tValidFileTestGeneric(testNum, "testFiles/validCalendar/testCalSimpleNoUTC.ics", _tSimpleCalendar(), 2);
}

testRec* _tValidFileTest2(int testNum){

    return _tValidFileTestGeneric(testNum, "testFiles/validCalendar/testCalSimpleUTC.ics", _tSimpleCalendarUTC(), 2);
}

testRec* _tValidFileTest3(int testNum){

    return _tValidFileTestGeneric(testNum, "testFiles/validCalendar/testCalSimpleUTCComments.ics", _tSimpleCalendarUTC(), 2);
}

testRec* _tValidFileTest4(int testNum){
    return _tValidFileTestGeneric(testNum, "testFiles/validCalendar/testCalEvtProp.ics", _tEvtPropCalendar(), 2);
}

testRec* _tValidFileTest5(int testNum){
    return _tValidFileTestGeneric(testNum, "testFiles/validCalendar/testCalProp.ics", _tSimpleCalendarProps(), 2);
}

testRec* _tValidFileTest6(int testNum){
    return _tValidFileTestGeneric(testNum, "testFiles/validCalendar/testCalEvts.ics", _tMultiEventCalendar(), 2);
}

testRec* _tValidFileTest7(int testNum){
    return _tValidFileTestGeneric(testNum, "testFiles/validCalendar/testCalEvtPropAlm.ics", _tAlmPropCalendar(), 2);
}

testRec* _tValidFileTest8(int testNum){
    return _tValidFileTestGeneric(testNum, "testFiles/validCalendar/mLineProp1.ics", _tFoldedCalendar1(), 2);
}

testRec* _tValidFileTest9(int testNum){
    return _tValidFileTestGeneric(testNum, "testFiles/validCalendar/mLinePropTab1.ics", _tFoldedCalendar1(), 2);
}

testRec* _tValidFileTest10(int testNum){
    return _tValidFileTestGeneric(testNum, "testFiles/validCalendar/testCalEvtPropAlm3.ics", _tFoldedCalendar3(), 2);
}

testRec* _tValidFileTest11(int testNum){
    return _tValidFileTestGeneric(testNum, "testFiles/validCalendar/mLineTab1.ics", _tFoldedCalendar2(), 2);
}
...
testRec* _tInvCalTest(int testNum){
    ...
    sprintf(feedback, "Test %d: Creating a Calendar object from files with invalid caldendars (expecting INV_CAL) ", testNum);
    testRec * rec = initRec(testNum, numSubs, feedback);
...
testRec* _tInvProdIDTest(int testNum){
    ...
    sprintf(feedback, "Test %d: Creating a Calendar object from files with invalid caldendars (expecting DUP_PRODID and INV_PRODID)", testNum);
    testRec * rec = initRec(testNum, numSubs, feedback);
...
testRec* _tInvVerTest(int testNum){
    ...
    sprintf(feedback, "Test %d: Creating a Calendar object from files with invalid caldendars (expecting DUP_VER and INV_VER)", testNum);
    testRec * rec = initRec(testNum, numSubs, feedback);
...
testRec* _tInvEvtTest(int testNum){
    ...
    sprintf(feedback, "Test %d: Parsing a file with an invalid event (misc errors, expecting INV_EVENT)", testNum);
    testRec * rec = initRec(testNum, numSubs, feedback);
...
testRec* _tInvDTTest(int testNum){
    ...
    sprintf(feedback, "Test %d: Parsing a file with an invalid date-time (expecting INV_DT)", testNum);
    testRec * rec = initRec(testNum, numSubs, feedback);
...
testRec* _tInvAlmTest(int testNum){
    ...
    sprintf(feedback, "Test %d: Parsing a file with an invalid alarm (expecting INV_ALARM)", testNum);
    testRec * rec = initRec(testNum, numSubs, feedback);
